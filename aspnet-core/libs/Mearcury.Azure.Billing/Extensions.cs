...
namespace Mearcury.Azure.Billing
{
    ...
    public static class Extensions
    {
        ...
        public static async Task UpdateBillingResourcesAsync(this Client client, CloudResources resources, DateTime startDate = default(DateTime), DateTime endDate = default(DateTime))
        {
            ...
            var rateCardDataTask = client.GetRateCardDataAsync();
            var usageDataTask = client.GetUsageDataAsync(startDate, endDate);

            await Task.WhenAll(rateCardDataTask, usageDataTask);

            var rateCardData = rateCardDataTask.Result;
            var usageData = usageDataTask.Result;
