...
{
    public abstract class MearcuryWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MearcuryWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MearcuryWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MearcuryDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MearcuryDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MearcuryDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MearcuryDbContext, Task<T>> func)
        {
            T result;
